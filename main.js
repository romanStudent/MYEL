...
console.log(arr_header_navigation);
for(let i = 0; i < 7; i++) {
  if(i === 3) {
...
function showSlides() {
  ...
  // let products_slides = document.getElementsByClassName("products-item");
...
console.log(document.querySelector('.way_create_content'));
// 1 блок блока "way_create"
let count = 2;
...
/*
let buttons_back_next = way_create_mobile();
 back = buttons_back_next[0];
 next = buttons_back_next[1];
*/
...
let languages_button = document.getElementsByClassName('languages-btn')[0].children[0];
  ...
  if (drop.style.display === 'block') {
   ...
   console.log(languages_button.style.color);
  }

}

languages_main.addEventListener('click', languages);
