...
let catalog_content_ite = document.querySelector('.catalog_content');
console.log(catalog_content_items);
...
catalog_content_ite.classList.add('flex');
...
let div3 = catalog_content_item_3.render_card();
 ...
 catalog_content_ite.append(div1);
catalog_content_ite.append(div2);
catalog_content_ite.append(div3);

if(innerWidth <= 700) {


console.log(catalog_content_ite.children);
...
catalog_content_item_3.render_card();
    catalog_content_ite.append(catalog_content_items[count]);
...
catalog_content_item_1.render_card();
    ...
    catalog_content_ite.prepend(catalog_content_items[count - 2]);
